// Exercise 1: Endless Rhythm recreation in Processing
// Recreation of Robert Delaunay's Endless Rhythm (1934) on Canvas 
// Albert Asuncion, 1/16/2018

void setup(){
  // size canvas with ratio 4 inches x 5.5 inches
  size(420, 550);
...
void draw(){
  ...
  noStroke();
  fill(108, 173, 124);
  arc(150, 361, 125, 125, radians(120), radians(300), CHORD);
  ...
  noStroke();
  fill(19, 113, 100);
  arc(200, 275, 125, 125, radians(-60), radians(120), CHORD);
